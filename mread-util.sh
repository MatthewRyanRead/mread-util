...
alias jsgripe='gripe --include \*.js --include \*.mustache --exclude *.map.js --exclude moment.js --exclude bundle.js --exclude *.*.js --exclude main.js --exclude templates.js --exclude-dir node_modules --exclude-dir testingData --exclude-dir packages'
